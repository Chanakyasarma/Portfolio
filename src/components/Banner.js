...
const Banner = () => {
    const handleButtonClick = () => {
        window.open('https://drive.google.com/file/d/1vuydCaXHwP-gXa-w-sxEQJq_LVrd32N9/view?usp=sharing', '_blank');
      };
      const handleButtonClick2 = () => {
        window.open('https://www.linkedin.com/in/chanakya-sarma/', '_blank');
      };
      const handleButtonClick3 = () => {
        window.open('https://github.com/Chanakyasarma', '_blank');
      };
        ...
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
            <div className='flex-1 text-center font-secondary lg:text-left'>
                ...
                <p className={`mb-8 max-w-lg mx-auto lg:mx-0 font-medium md:hidden`}>
                    ...
                    Developer and Graphic Designer from Assam, India, I specialize in creating visually stunning websites and user interfaces. With expertise in HTML, CSS, JavaScript, and design software, I blend technical skills with artistic flair to deliver exceptional digital experiences that captivate and engage users.
                </p>
            ...
            <div className='img lg:flex items-center justify-center lg:h-[500px] md:mx-20 mb-24 pb-14'>
                    <div className="group relative h-full w-full overflow-hidden rounded-b-full aspect-[1/1.35] flex items-end">
                      <div className="bg-red-500 absolute h-3/4 w-full rounded-full bottom-0 border-2 border-white"></div>
                    
                      {/* Mobile: image stays clipped */}
                      <img
                        className="relative w-full h-full object-cover lg:hidden"
                        src={Image}
                        alt="image"
                      />
                    
                      {/* Desktop: image zooms out of the circle */}
                      <img
                        className="relative h-max w-full transition-all duration-500 hidden lg:block group-hover:scale-150"
                        src={Image}
                        alt="image"
                      />
                    </div>
