            ...
            <div className="flex flex-wrap items-top mb-6">
              <div className="w-full lg:w-4/12 px-4 ml-auto">
                ...
                <ul className="list-unstyled">
                  <li>
                    <a className="text-orange-200 hover:text-orange-300 font-semibold block pb-2 text-sm" href="https://leetcode.com/Chanakya5/">Leetcode</a>
                  </li>
                  <li>
                    <a className="text-orange-200 hover:text-orange-300 font-semibold block pb-2 text-sm" href="https://dev.to/chanakyasarma">Blog</a>
                  </li>
                  <li>
                    <a className="text-orange-200 hover:text-orange-300 font-semibold block pb-2 text-sm" href="https://github.com/Chanakyasarma">Github</a>
                  </li>
                  <li>
                    <a className="text-orange-200 hover:text-orange-300 font-semibold block pb-2 text-sm" href="https://www.instagram.com/_mr.chanakya._/">Instagram</a>
                  </li>
                </ul>
              </div>
            </div>
