...
const ToggleButton = () => {
  ...
  return (
    <label className="relative inline-flex items-center cursor-pointer">
      ...
      after:bg-orange-300 after:border-orange-100 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-rose-600 peer-checked:bg-orange-100">
      </div>
    </label>
  );
};
